...
import { initDTOStudentModel } from "../3.1.student/7.dto.model";
import { initDTOTeacherModel } from "../3.2.teacher/7.dto.model";
...
export async function initModels(schemaName: string, sequelize: Sequelize) {
  ...
  initDTOTeacherModel(schemaName, sequelize);
